...
public partial class GameplayEntity {
    ...
    public PositionListenerComponent positionListener { get { return (PositionListenerComponent)GetComponent(GameplayComponentsLookup.PositionListener); } }
    public bool hasPositionListener { get { return HasComponent(GameplayComponentsLookup.PositionListener); } }

    public void AddPositionListener(System.Collections.Generic.List<IPositionListener> newValue) {
        var index = GameplayComponentsLookup.PositionListener;
    ...
    public void RemovePositionListener() {
        RemoveComponent(GameplayComponentsLookup.PositionListener);
    }
}
...
public sealed partial class GameplayMatcher {
    ...
    static Entitas.IMatcher<GameplayEntity> _matcherPositionListener;

    public static Entitas.IMatcher<GameplayEntity> PositionListener {
        get {
            if (_matcherPositionListener == null) {
                var matcher = (Entitas.Matcher<GameplayEntity>)Entitas.Matcher<GameplayEntity>.AllOf(GameplayComponentsLookup.PositionListener);
